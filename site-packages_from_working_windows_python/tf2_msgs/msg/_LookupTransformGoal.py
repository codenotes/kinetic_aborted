...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2I2i2I.pack(_x.source_time.secs, _x.source_time.nsecs, _x.timeout.secs, _x.timeout.nsecs, _x.target_time.secs, _x.target_time.nsecs))
      _x = self.fixed_frame
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.advanced))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.source_time.secs, _x.source_time.nsecs, _x.timeout.secs, _x.timeout.nsecs, _x.target_time.secs, _x.target_time.nsecs,) = _struct_2I2i2I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
