...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.x, _x.y, _x.z, _x.r, _x.l_x, _x.l_y, _x.l_z,) = _struct_7d.unpack(str[start:end])
      return self
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3I.pack(_x.sub_map.header.seq, _x.sub_map.header.stamp.secs, _x.sub_map.header.stamp.nsecs))
      ...
      _x = self
      buff.write(_struct_2I.pack(_x.sub_map.height, _x.sub_map.width))
      ...
      _x = self
      buff.write(_struct_B2I.pack(_x.sub_map.is_bigendian, _x.sub_map.point_step, _x.sub_map.row_step))
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.sub_map.is_dense))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(_x))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(_x))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.sub_map.header.seq, _x.sub_map.header.stamp.secs, _x.sub_map.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      ...
      (_x.sub_map.height, _x.sub_map.width,) = _struct_2I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.sub_map.fields = []
      ...
      (_x.sub_map.is_bigendian, _x.sub_map.point_step, _x.sub_map.row_step,) = _struct_B2I.unpack(str[start:end])
      ...
      (self.sub_map.is_dense,) = _struct_B.unpack(str[start:end])
